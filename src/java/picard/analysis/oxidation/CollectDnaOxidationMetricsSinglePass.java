...
/**
 * CollectDnaOxidationMetrics implemented as a SinglePassSamProgram, i.e. a read-order traversal,
 * which basically involves turning SamLocusIterator inside-out.
 *
 * @author mattsooknah
 *
 */
@CommandLineProgramProperties(
        usage = CollectDnaOxidationMetricsSinglePass.USAGE,
        usageShort = CollectDnaOxidationMetricsSinglePass.USAGE,
        programGroup = Metrics.class
)
public class CollectDnaOxidationMetricsSinglePass extends SinglePassSamProgram {
    ...
    private final Log log = Log.getInstance(CollectDnaOxidationMetricsSinglePass.class);
    ...
    public static void main(final String[] args) {
        new CollectDnaOxidationMetricsSinglePass().instanceMainWithExit(args);
    }
